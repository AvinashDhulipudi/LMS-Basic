    ...
    render() {
      ...
      const authLinks =(
          ...
          <li className="nav-item">
            <Link className="nav-link" to="/addclass"> Add Course </Link>
          </li>
          <li className="nav-item">
            <Link className="nav-link" to="/registerclass"> Register Course </Link>
          </li>
          <li className="nav-item">
...
export default connect(mapStatetToProps,{ logoutUser, clearCurrentUser })(Navbar);